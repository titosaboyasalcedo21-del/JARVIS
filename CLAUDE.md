...
5. Generate SSL certs: openssl req -x509 -newkey rsa:2048 -keyout key.pem -out cert.pem -days 365 -nodes -subj '/CN=localhost'
6. Run the backend: python server.py
7. Run the overlay: python desktop-overlay/linux_overlay.py
8. Speak to JARVIS through the orb overlay.
